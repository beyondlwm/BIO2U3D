...
{	
	...
	// Hack_Severin : private accessor used only to avoid warning (unused variables)
	// In player build (because only used in editor)
	private int Padding
	{
		get
		{
	...
	private AtlasSize MaximumAtlasSize
	{
		get
		{
			return m_eMaximumAtlasSize;
		}
	}
